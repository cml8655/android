...
final public class NetworkUtilities {
	...
	public static String authenticate(String username, String password) {
		...
		Log.i("net", "用户登陆：" + username + ":" + password);
		return "111122222";
	 ...
	 */
	public static List<RawContact> syncContacts(Account account,
			String authtoken, long serverSyncState,
			List<RawContact> dirtyContacts) throws JSONException,
		...
		// params.add(new BasicNameValuePair(PARAM_CONTACTS_DATA, buffer
		// .toString()));
		// if (serverSyncState > 0) {
		// params.add(new BasicNameValuePair(PARAM_SYNC_STATE, Long
		// .toString(serverSyncState)));
		// }
	...
	public static byte[] downloadAvatar(final String avatarUrl) {
		...
		Log.i("tag", "开始下载头像吧：downloadAvatar");
